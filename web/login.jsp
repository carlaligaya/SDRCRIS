<%-- 
    Document   : login
    Created on : 01 30, 18, 12:19:59 AM
    Author     : RDE
--%>
        ...
        <div class="content">
            ...
            <form class="register-form" action="SignUp" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Specialization" name="specializations" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Master's Degree</label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Master's Degree" name="masters" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Doctorate Degree</label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Doctorate Degree" name="doctorate" /> </div>
