...
<div class="bg-light lter b-b wrapper-md hidden-print">
  ...
  <h1 class="m-n font-thin h3">Production Reports / PB-1000</h1>
</div>
  ...
  <div>
    <div class="well m-t bg-light lt">
      <div class="row">
          ...
          <STRONG>P.Os COVERED:</STRONG> <BR> <a href="PO.html">PO-00002</a>
    ...
    <table class="table table-striped bg-white b-a">
      <thead>
        <tr>
            ...
            <th>DESCRIPTION</th>
            <th>QTY ORDERED</th>
            <th style="width: 400px">ACTUAL QTY PRODUCED</th>
        </tr>
      </thead>
      <tbody>
        <tr>
        ...
        <TD>CHMK500</TD>
          <td>500ml Chocolate Milk</td>
            <td>51</td>
             <td><input type="number" min="0" ui-options="" class="form-control w-md" /></td>
       ...
       <button class="btn m-b-xs w-xs btn-default">Reset</button><button class="btn m-b-xs w-xs btn-success">Submit</button>
  </div>
</div>
