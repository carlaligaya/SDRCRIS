        ...
        <div class="container">
            ...
            <div class="hor-menu">
                ...
                <%} 
                  ...
                  <jsp:include page="principal_investigator_header.jsp" />
                
                <%} 
                else if (ut==3) {%>
                  <jsp:include page="research_deputy_header.jsp" />
                
                <%}
                else if (ut==4) {%>
                  <jsp:include page="research_associate_header.jsp" />
                
                <%}
                else if (ut==3) {%>
                  <jsp:include page="public_access_header.jsp" />
