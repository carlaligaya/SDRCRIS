                                           ...
                                           <ul class="dropdown-menu pull-left">
                                                <li aria-haspopup="true" class="">
                                                    <a href="manage_user.jsp" class="nav-link">
                                                        <i class="glyphicon glyphicon-user"></i> Manage Users</a>
                                                </li>
                                                ...
                                                <li aria-haspopup="true" class=" ">
                                                    <a href="manage_project.jsp" class="nav-link">
                                                     ...
                                                     <li aria-haspopup="true" class=" ">
                                                    <a href="reg_principal_investigator.jsp" class="nav-link">
                                                        <i class="glyphicon glyphicon-list"></i> Register Principal Investigator
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
