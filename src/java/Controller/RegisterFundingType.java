 ...
 * @author RDE
 */
public class RegisterFundingType extends BaseServlet {
    ...
    protected void servletAction(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ServletException, IOException {
        ...
        if(fDAO.addFundingType(fot)){
            out.println("<script type=\"text/javascript\">");
            out.println("alert('Funding Organization Type has been Successfully Registered!');");
            out.println("location='/SDRCRIS/reg_funding_organization_type.jsp';");
            out.println("</script>");
        }else{
            out.println("<script type=\"text/javascript\">");
            out.println("alert('Funding Organization Type has been Unsuccessfully Registered!');");
            out.println("location='/SDRCRIS/reg_funding_organization_type.jsp';");
            out.println("</script>");
        }
